...
public class GirlDormFragment extends Fragment {
    RecyclerView recyclerView;

    public GirlDormFragment() {
        // Required empty public constructor
    }
    // TODO: Rename and change types and number of parameters
    public static GirlDormFragment newInstance() {
        GirlDormFragment fragment = new GirlDormFragment();
        return fragment;
    }
    ...
    public final static class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerHolder> {
        ...
        public void onBindViewHolder(RecyclerAdapter.RecyclerHolder holder, int position) {
            ...
            GirlNumberAdapter dormNumberAdapter = new GirlNumberAdapter(mContext);
