...
public class GirlNumberAdapter extends RecyclerView.Adapter<DormNumberViewHolder> {
    private Context mContext;
    private List<String> mList = new ArrayList<>();

    public GirlNumberAdapter(Context context) {
    ...
    public void onBindViewHolder(DormNumberViewHolder holder, final int position) {
        ...
        holder.mDormNumber.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("title","女生宿舍"+mList.get(position));
